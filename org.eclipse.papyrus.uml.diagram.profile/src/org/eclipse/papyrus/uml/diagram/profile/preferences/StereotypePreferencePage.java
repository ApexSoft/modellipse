 ...
 * @generated
 */
public class StereotypePreferencePage extends AbstractPapyrusNodePreferencePage {
	 ...
	 * @generated
	 */
	public StereotypePreferencePage() {
		super();
		setPreferenceKey(ProfileDiagramEditPart.MODEL_ID + "_Stereotype");
	}
