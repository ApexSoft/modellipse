 ...
 */
public class ApexCustomZOrderCommand extends AbstractTransactionalCommand {
	 ...
	 * @param view
	 */
	public ApexCustomZOrderCommand(TransactionalEditingDomain editingDomain, View view, int index) {
