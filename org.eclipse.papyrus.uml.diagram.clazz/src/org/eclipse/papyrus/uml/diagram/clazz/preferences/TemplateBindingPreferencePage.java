...
public class TemplateBindingPreferencePage extends AbstractPapyrusLinkPreferencePage {
	 ...
	 * @generated
	 */
	public TemplateBindingPreferencePage() {
		super();
		setPreferenceKey(ModelEditPart.MODEL_ID + "_TemplateBinding");
	}
	...
	private static TreeMap<String, String> getStaticLabelRole() {
		...
		map.put("TemplateParameterSubstitution", "platform:/plugin/org.eclipse.uml2.uml.edit/icons/full/obj16/TemplateParameterSubstitution.gif");//$NON-NLS-1$ //$NON-NLS-2$
