 ...
 * @generated
 */
public class RedefinableTemplateSignaturePreferencePage extends AbstractPapyrusNodePreferencePage {

	/**
	 * @generated
	 */
	public static final String compartments[] = { "TemplateParameterCompartment" };

	/**
	 * @generated
	 */
	public RedefinableTemplateSignaturePreferencePage() {
		super();
		setPreferenceKey(ModelEditPart.MODEL_ID + "_RedefinableTemplateSignature");
	}
	...
	private static TreeMap<String, Boolean> getStaticCompartmentVisibilityPreferences() {
		...
		map.put("TemplateParameterCompartment", Boolean.TRUE);
		return map;
	}
	...
	private static TreeMap<String, Boolean> getStaticCompartmentTitleVisibilityPreferences() {
		TreeMap<String, Boolean> map = new TreeMap<String, Boolean>();
		map.put("TemplateParameterCompartment", Boolean.FALSE);
		return map;
	}
