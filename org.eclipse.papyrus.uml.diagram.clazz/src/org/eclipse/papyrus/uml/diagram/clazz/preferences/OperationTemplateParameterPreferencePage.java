 ...
 * @generated
 */
public class OperationTemplateParameterPreferencePage extends AbstractPapyrusNodePreferencePage {

	/**
	 * @generated
	 */
	public OperationTemplateParameterPreferencePage() {
		super();
		setPreferenceKey(ModelEditPart.MODEL_ID + "_OperationTemplateParameter");
	}
