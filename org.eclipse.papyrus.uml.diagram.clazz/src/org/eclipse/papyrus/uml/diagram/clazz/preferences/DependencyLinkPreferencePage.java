 ...
 * @generated
 */
public class DependencyLinkPreferencePage extends AbstractPapyrusLinkPreferencePage {

	/**
	 * @generated
	 */
	public DependencyLinkPreferencePage() {
		super();
		setPreferenceKey(ModelEditPart.MODEL_ID + "_DependencyLink");
	}
