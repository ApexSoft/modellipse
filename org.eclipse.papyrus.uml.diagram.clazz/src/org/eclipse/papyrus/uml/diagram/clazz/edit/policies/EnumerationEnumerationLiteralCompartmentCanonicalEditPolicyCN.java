...
public class EnumerationEnumerationLiteralCompartmentCanonicalEditPolicyCN extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getEnumerationEnumerationLiteralCompartment_7031SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getEnumerationEnumerationLiteralCompartment_7031SemanticChildren((View)getHost().getModel());
