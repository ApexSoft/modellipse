...
public class ElementToStereotypedShape extends RecordingCommand {
	...
	protected void doExecute() {
		...
		Node packageview = umlViewProvider.createNamedElement_2023(elementEditPart.resolveSemanticElement(), (View)elementEditPart.getNotationView().eContainer(), -1, true, elementEditPart.getDiagramPreferencesHint());
