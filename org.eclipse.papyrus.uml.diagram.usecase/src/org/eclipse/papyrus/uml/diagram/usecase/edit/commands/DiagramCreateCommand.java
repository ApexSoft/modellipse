 ...
 * @generated
 */
public class DiagramCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public DiagramCreateCommand(CreateElementRequest req, EObject eObject) {
	 ...
	 * @generated
	 */
	public static DiagramCreateCommand create(CreateElementRequest req, EObject eObject) {
		return new DiagramCreateCommand(req, eObject);
	}

	/**
	 * @generated
	 */
	public DiagramCreateCommand(CreateElementRequest req) {
		super(req.getLabel(), null, req);
	}
