 ...
 * <ul>
 *   <li>{@link org.eclipse.papyrus.uml.alf.alf.ClassificationFromClause#getQualifiedNameList <em>Qualified Name List</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.papyrus.uml.alf.alf.AlfPackage#getClassificationFromClause()
 * @model
 * @generated
 */
public interface ClassificationFromClause extends EObject
{
   ...
   * @see org.eclipse.papyrus.uml.alf.alf.AlfPackage#getClassificationFromClause_QualifiedNameList()
  ...
  /**
   * Sets the value of the '{@link org.eclipse.papyrus.uml.alf.alf.ClassificationFromClause#getQualifiedNameList <em>Qualified Name List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
