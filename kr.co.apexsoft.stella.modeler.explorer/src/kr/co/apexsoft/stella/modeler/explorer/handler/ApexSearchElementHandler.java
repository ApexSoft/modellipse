...
import kr.co.apexsoft.stella.modeler.explorer.dialog.ApexNavigatorSearchDialog;
 ...
 * 
 */
public class ApexSearchElementHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		ApexNavigatorSearchDialog dialog = new ApexNavigatorSearchDialog(shell, getSelectedTreeViewer(event));
		dialog.open();
		return null;
	}
