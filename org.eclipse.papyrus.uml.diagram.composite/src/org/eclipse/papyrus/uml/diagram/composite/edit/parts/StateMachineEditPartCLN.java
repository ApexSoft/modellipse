...
import org.eclipse.papyrus.uml.diagram.composite.edit.policies.StateMachineItemSemanticEditPolicyCLN;
...
implements ITextAwareEditPart, IPrimaryEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.StateMachine_3106, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.composite.edit.parts.StateMachineEditPartCLN.VISUAL_ID));
		}
		return parser;
	}
