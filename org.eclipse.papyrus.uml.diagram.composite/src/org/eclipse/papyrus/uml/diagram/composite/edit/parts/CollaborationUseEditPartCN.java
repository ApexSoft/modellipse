...
NamedElementEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new org.eclipse.papyrus.uml.diagram.composite.custom.edit.policies.CollaborationUseItemSemanticEditPolicyCN());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.uml.diagram.composite.edit.parts.CollaborationUseEditPartCN) {
			types.add(UMLElementTypes.ComponentRealization_4004);
		}
