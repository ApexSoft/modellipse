...
import org.eclipse.papyrus.uml.diagram.composite.edit.policies.FunctionBehaviorItemSemanticEditPolicyCLN;
...
implements ITextAwareEditPart, IPrimaryEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.FunctionBehavior_3107, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.composite.edit.parts.FunctionBehaviorEditPartCLN.VISUAL_ID));
		}
		return parser;
	}
