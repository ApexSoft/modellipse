...
import org.eclipse.papyrus.uml.diagram.composite.edit.policies.ProtocolStateMachineItemSemanticEditPolicyCLN;
...
implements ITextAwareEditPart, IPrimaryEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ProtocolStateMachine_3105, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.composite.edit.parts.ProtocolStateMachineEditPartCLN.VISUAL_ID));
		}
		return parser;
	}
