...
import org.eclipse.papyrus.uml.diagram.composite.edit.policies.ClassItemSemanticEditPolicyCLN;
...
implements ITextAwareEditPart, IPrimaryEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Class_3114, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.composite.edit.parts.ClassEditPartCLN.VISUAL_ID));
		}
		return parser;
	}
