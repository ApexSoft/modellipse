...
import org.eclipse.papyrus.uml.diagram.composite.edit.policies.ReceptionItemSemanticEditPolicyCLN;
...
implements ITextAwareEditPart, IPrimaryEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Reception_3100, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.composite.edit.parts.ReceptionEditPartCLN.VISUAL_ID));
		}
		return parser;
	}
