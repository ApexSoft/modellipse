package kr.co.apexsoft.stella.modeler.custom.editors.message.dialogs;
...
import kr.co.apexsoft.stella.modeler.custom.editors.message.Messages;
...
public class CreateOrModifySignatureDialog extends FormDialog {
	...
	private void createCreationSection(Composite pParent, FormToolkit pToolkit) {
		...
		creationRadio = pToolkit.createButton(lBody, Messages.CreateOrModifySignatureDialog_CreationRadio_Text, SWT.RADIO);
		...
		if(possibleTypes.size() > 1) {
			pToolkit.createLabel(lBody, Messages.CreateOrModifySignatureDialog_TypeLabel_Text, SWT.NONE);
		...
		pToolkit.createLabel(lBody, Messages.CreateOrModifySignatureDialog_NameLabel_Text, SWT.NONE);
		...
		pToolkit.createLabel(lBody, Messages.CreateOrModifySignatureDialog_OwnerLabel_Text, SWT.NONE);
	...
	private void createNothingSection(Composite pParent, FormToolkit pToolkit) {
		...
		// content of the section
		nothingRadio = pToolkit.createButton(lBody, Messages.CreateOrModifySignatureDialog_NoElementRadio_Text, SWT.RADIO);
